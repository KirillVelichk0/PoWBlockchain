...
#ifndef GOOGLE_PROTOBUF_INCLUDED_BlockExternal_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_BlockExternal_2eproto
...
struct TableStruct_BlockExternal_2eproto {
  static const uint32_t offsets[];
};
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_BlockExternal_2eproto;
...
class Block_Key final :
 ...
 private:
  ...
  union { Impl_ _impl_; };
  friend struct ::TableStruct_BlockExternal_2eproto;
};
// -------------------------------------------------------------------
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_BlockExternal_2eproto
